# Generated by Django 4.0.5 on 2022-06-14 14:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=50)),
                ('default_odds', models.DecimalField(decimal_places=10, max_digits=10)),
                ('shiny_charm_odds', models.DecimalField(decimal_places=10, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trainer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hunts', to='app_api.trainer')),
            ],
        ),
        migrations.CreateModel(
            name='Following',
